...
const DEFAULT_IMAGES: ImageItem[] = [
  ...
  { src: Java, alt: "Java" },
  { src: Github, alt: "Git / GitHub" },
  { src: Vite, alt: "Vite" },
  { src: ReactIcon, alt: "React" },
  { src: TailwindCSS, alt: "Tailwind CSS" },
  { src: NodeJS, alt: "Node.js" },
  { src: MongoDB, alt: "Database" },
  { src: Postman, alt: "API Testing" },
  { src: MaterialUI, alt: "UI Design" },
  { src: Bootstrap, alt: "Bootstrap" },
  { src: Docker, alt: "Deployment" },
  { src: Vercel, alt: "Vercel" },
  { src: Notion, alt: "Documentation" },
  { src: StackOverflow, alt: "Problem Solving" },
];
