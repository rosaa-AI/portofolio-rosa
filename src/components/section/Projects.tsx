...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Sistem Informasi Akademik CRUD",
      description:
        "Aplikasi berbasis web untuk mengelola data akademik seperti data mahasiswa, dosen, dan mata kuliah. Sistem ini dibuat untuk membantu proses input, update, hapus, dan pencarian data agar lebih rapi dan efisien.",
      technologies: ["PHP", "MySQL", "HTML", "CSS"],
      icon: comingSoon,
      detailsUrl: "/projects/academic-crud",
      githubUrl: "https://github.com/rosaa-AI",
    },
    {
      title: "Aplikasi Absensi QR Code",
      description:
        "Aplikasi absensi digital berbasis QR Code untuk mempermudah proses kehadiran. Sistem ini dirancang agar pencatatan absensi menjadi lebih cepat, praktis, dan mudah dipantau.",
      technologies: ["Java", "Android Studio", "Firebase"],
      icon: comingSoon,
      detailsUrl: "/projects/qr-attendance",
      githubUrl: "https://github.com/rosaa-AI",
    },
    {
      title: "Redesign UI/UX E-Commerce",
      description:
        "Studi kasus desain ulang tampilan aplikasi e-commerce dengan fokus pada kemudahan navigasi, konsistensi visual, dan pengalaman pengguna yang lebih nyaman saat melihat produk hingga checkout.",
      technologies: ["Figma", "UI/UX", "Prototype"],
      icon: comingSoon,
      detailsUrl: "/projects/ecommerce-redesign",
      githubUrl: "https://github.com/rosaa-AI",
    },
    {
      title: "Web Portfolio Pribadi",
      description:
        "Website portofolio pribadi untuk menampilkan profil, kemampuan, project, pengalaman, dan kontak. Website ini dibuat sebagai media personal branding di bidang Sistem Informasi dan teknologi.",
      technologies: ["React", "TypeScript", "Tailwind CSS"],
      icon: comingSoon,
      detailsUrl: "/projects/personal-portfolio",
      githubUrl: "https://github.com/rosaa-AI",
    },
  ];
          ...
          <div className="flex items-center justify-center gap-1 mb-4">
            ...
            <Tooltip>
              ...
              <TooltipContent className="bg-white text-gray-800 border-pink-200">
                <p>Project portfolio Rosa Silaban</p>
              </TooltipContent>
            </Tooltip>
          </div>
          <p className="text-center mb-12 text-lg text-gray-600 dark:text-gray-300">
            Beberapa project yang pernah saya kerjakan di bidang web
            development, UI/UX, database, dan sistem informasi
          </p>
