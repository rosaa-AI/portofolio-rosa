...
const Certifications = () => {
  ...
  const badges = [
    {
      id: "ditekindo",
      image: "/certificates/ditekindo.png",
      alt: "DITEKINDO Certificate",
      title: "DITEKINDO",
      subtitle: "Certificate",
      credentialUrl: "/certificates/ditekindo.png",
      status: "completed",
    },
    {
      id: "hp-life",
      ...
      title: "HP LIFE",
      subtitle: "Certificate",
      credentialUrl: "/certificates/hp-life.png",
      status: "completed",
    },
  ];
  ...
  const credentials = [
    {
      id: "maju-bareng-ai",
      image: "/certificates/maju-bareng-ai.png",
      alt: "Maju Bareng AI Certificate",
      ...
      expires: "-",
      credentialId: "-",
      credentialUrl: "/certificates/maju-bareng-ai.png",
      status: "completed",
    },
    {
      id: "revo-u",
      image: "/certificates/revo-u.png",
      alt: "RevoU Certificate",
      title: "RevoU",
      subtitle: "Technology / Digital Skill Certificate",
      issuer: "RevoU",
      issued: "2025",
      expires: "-",
      credentialId: "-",
      credentialUrl: "/certificates/revo-u.png",
      status: "completed",
    },
  ];
            ...
            {badges.map((badge) => {
              const BadgeComponent = () => (
                <div className="flex flex-col items-center group">
                  ...
                  >
                    {badge.subtitle ||
                      (badge.status === "in-progress" ? "In Progress!" : "")}
                  </p>
                </div>
              );
